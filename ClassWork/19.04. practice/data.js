...
//////////////5\\
// console.log(countries_data.filter((el)=> el.region.includes("Asia") || el.region.includes("Asia") ))

/////////////6\\
// console.log(countries_data.filter((el)=> el.languages.length>1 ))
 
/////////////7\\
// console.log(countries_data.map((el)=> `${el.name},${el.capital}`))

////////////8\\
// console.log(countries_data.reduce((sum,prev)=> sum+=prev.population ,0))