...
function cards(arr) {
  arr.forEach((element) => {
    ...
    <div class="col col-3">
      <div class="card" style="width: 18rem m-5 d-flex g-4">
        <div class="card-body">
          <h5 class="card-title">${element.title}</h5>
          <p class="card-text">${element.publisher}</p>
          <p class="card-year">${element.year}</p>
          <button class="btn btn-primary">Add to wishes</button>
        </div>
      </div>
    </div>
